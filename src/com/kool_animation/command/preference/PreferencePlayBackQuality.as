package com.kool_animation.command.preference
{
	...
	public class PreferencePlayBackQuality extends SimpleCommand 
	{
				override public function execute(notification:INotification):void {
					var playbackQuality:String= notification.getBody().workSpace as String;
					var preferenceProxy:PreferencesProxy = facade.retrieveProxy(PreferencesProxy.NAME) as PreferencesProxy;
					if(preferenceProxy.setWorkspaceDirectory(playbackQuality)){
